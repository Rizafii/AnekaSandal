<div class="px-3 py-10 mt-16 bg-secondary">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="mt-16">
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100/50 overflow-hidden">
                <div class="bg-gradient-to-r from-yellow-50 to-yellow-100/50 border-b border-yellow-200/70">
                    <div class="px-8 py-6">
                        <div class="flex items-center gap-3">
                            ...
                            <h2 class="text-2xl font-bold text-gray-800">Testimoni Pelanggan</h2>
                            @php
                                $testimonials = $product['testimonials'] ?? [];
                                $avgRating = count($testimonials) > 0 ? array_sum(array_column($testimonials, 'rating')) / count($testimonials) : 0;
                            @endphp
                            @if(count($testimonials) > 0)
                                <div class="ml-auto flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-semibold text-gray-700">{{ number_format($avgRating, 1) }}
                                        ({{ count($testimonials) }} ulasan)</span>
                                </div>
                            @endif
                        </div>
                    </div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <div class="flex items-center gap-3 mb-2">
                                                ...
                                                <span
                                                    class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($testimonial['created_at'])->diffForHumans() }}</span>
                                            </div>
                                            @if($testimonial['review'])
                                                <p class="text-gray-700 mb-3 leading-relaxed">{{ $testimonial['review'] }}</p>
                                            @endif
                                            @if($testimonial['image_path'])
                                                <div class="mt-3">
                                                    <img src="{{ Storage::url($testimonial['image_path']) }}" alt="Foto testimoni"
                        ...
                        <div class="text-center py-12">
                            <div class="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg class="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M7 8h10m0 0V6a2 2 0 00-2-2H9a2 2 0 00-2 2v2m10 0v10a2 2 0 01-2 2H9a2 2 0 01-2-2V8m10 0H7m5 5v6m-3-3h6">
                                    </path>
                                </svg>
                            </div>
    ...
    <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4"
        ...
        <div class="max-w-4xl max-h-full">
            <img id="modalImage" src="" alt="Testimoni" class="max-w-full max-h-full object-contain rounded-lg">
        </div>
    </div>
