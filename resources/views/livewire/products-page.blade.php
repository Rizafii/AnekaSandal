        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="max-w-2xl mx-auto">
                <div class="relative">
                    ...
                    <button class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-pink-600 hover:bg-pink-700 text-white rounded-full p-3 transition-colors duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex justify-between items-center mb-8">
                <p class="text-gray-600">
                    Menampilkan <span class="font-semibold text-gray-900">{{ $products->firstItem() ?? 0 }}-{{ $products->lastItem() ?? 0 }}</span> dari 
                            ...
                            <div class="group">
                                <a href="{{ route('product.detail', $product->id) }}"
                                    ...
                                    <div class="relative overflow-hidden">
                                        ...
                                        <!-- Stock Badge -->
                                        @if($product->stock <= 5)
                                            <div class="absolute bottom-4 left-4 bg-orange-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                                                STOK TERBATAS
                                            </div>
                                        @elseif($product->stock > 0)
                                            <div class="absolute bottom-4 left-4 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                                                TERSEDIA
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex items-center mb-3">
                                            ...
                                            <span class="text-gray-600 text-sm ml-2">({{ $product->rating ?? '5.0' }})</span>
                                        </div>
                            ...
                            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300">
                                <a href="{{ route('product.detail', $product->id) }}" class="flex flex-col md:flex-row">
                                    ...
                                    <div class="md:w-2/3 p-6 flex flex-col justify-between">
                                        <div>
                                            <h3 class="text-xl font-bold text-gray-900 mb-2 hover:text-pink-600 transition-colors duration-300">
                                                {{ $product->name }}
                                            </h3>
