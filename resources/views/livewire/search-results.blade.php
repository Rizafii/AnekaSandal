    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-lg mt-2 max-w-md">
        <div class="p-2">
            ...
            <ul class="space-y-1">
                ...
                <li>
                    ...
                    >
                        ...
                        <img src="{{ $product->images->first()->image_url }}" alt="{{ $product->name }}" class="w-10 h-10 object-cover rounded">
                        @else
            ...
            <div class="pt-2 border-t border-gray-100">
                <a href="{{ route('search', ['q' => $search]) }}" class="block text-center text-sm text-blue-600 hover:text-blue-800">
