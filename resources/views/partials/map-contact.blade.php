    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="order-2 lg:order-1">
                <div class="bg-gray-100 rounded-2xl overflow-hidden shadow-lg h-96 lg:h-[500px]">
                    <iframe
            ...
            <div class="order-1 lg:order-2 space-y-8">
                <div>
                    ...
                    <p class="text-gray-600 mb-8">
                        Kami siap melayani Anda dengan produk sandal berkualitas terbaik. Jangan ragu untuk menghubungi
                        kami!
                    </p>
                </div>
                ...
                <div class="space-y-6">
                    <!-- Address -->
                    <div
                        class="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl hover:bg-pink-50 transition-colors duration-300">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Jl. Sekarpetak KM 1, Jatipuro, Jatipuro,<br>
                    ...
                    <!-- WhatsApp -->
                    <div
                        class="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl hover:bg-green-50 transition-colors duration-300">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-8">
                    <a href="https://wa.me/6288226532872" target="_blank"
                        class="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-300 transform hover:scale-105 text-center">
                    ...
                    <a href="tel:+6288226532872"
                        class="flex-1 bg-pink-600 hover:bg-pink-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-300 transform hover:scale-105 text-center">
                        <div class="flex items-center justify-center space-x-2">
